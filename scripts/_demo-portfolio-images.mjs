...
const ITEMS = [
  ...
  { f: 'IMG_6190', slug: 'drink-bottles-pair',  cat: 'drinkware', title: 'ขวดน้ำแก้วใสสกรีนโลโก้',           brand: 'jobsdb' },
  ...
  { f: 'IMG_6630', slug: 'fan-jobsdb',          cat: 'fan',       title: 'พัดลมพกพาสกรีนโลโก้ พร้อมกล่อง',   brand: 'jobsdb' },
  { f: 'IMG_6659', slug: 'pen-jobsdb',          cat: 'stationery',title: 'ปากกาสกรีนโลโก้ สีประจำแบรนด์',    brand: 'jobsdb' },
