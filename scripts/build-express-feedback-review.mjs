...
const ROWS = [
  ...
  ['EX028', 'รูป ⚠', 'รูปเดิม 2 ใบเป็นรุ่นผิดทั้งคู่ → ใช้รูปสินค้าจริงจากเอกสาร (พื้นโกดัง — ถ้าอยากได้สตูดิโอต้อง restyle เสียเงิน)'],
  ...
  ['EX099', 'สเปก', 'ขนาดขึ้นบรรทัด ไซส์ S / ไซส์ L (รูปยังรอซัพส่งกระเป๋าเปล่า)'],
...
<h1>สินค้าส่งด่วน — feedback รอบ 2026-07-30 · ทำแล้ว 42/45</h1>
<p>รูปที่เห็นคือแกลเลอรีจริงหลังแก้ (สูงสุด 4 ใบแรก) · กด SKU เพื่อเปิดหน้าจริงบนเว็บ (ยังเป็นเวอร์ชันเก่าจนกว่าจะ deploy)</p>
</div></header>
<div class="wrap">
<div class="box warn"><h2>⏳ เหลือ 3 เรื่อง — รอทีม / รอ Golf</h2><ul>
<li><b>ขอรูปซัพ 3 รายการ</b> — EX031/EX034 (ต้องเห็นหูหิ้ว) · EX099 (กระเป๋าเปล่า ไม่มีโลโก้ Mövenpick) · EX131</li>
<li><b>ตัดสินใจ merge EX031 + EX034</b> — เก็บ SKU ไหน / ชื่อใหม่ / ชุดสี / ราคาโชว์</li>
<li><b>EX028 รูปหลัก</b> — ตอนนี้เป็นรูปซัพจริง (พื้นโกดัง) เพราะรูปเดิมเป็นรุ่นผิด · อยากได้สตูดิโอต้อง restyle แบบเสียเงิน → จะ quote ฿ ก่อนทุกครั้ง</li>
</ul></div>
...
สร้างโดย scripts/build-express-feedback-review.mjs · commit 61efdd8 + 16e0bf7 (ยังไม่ push)</p>
</div></body></html>`;
