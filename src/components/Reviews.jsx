...
const ITEMS = [
  { q: 'งานดีไซน์เนี้ยบ ส่งตรงเวลา คุยง่าย ทำให้มั่นใจที่จะสั่งต่อในปีถัดไป', r: 'ฝ่าย HR · องค์กรเอกชน', a: 'H' },
  { q: 'AI ช่วยร่นเวลาเลือกของได้เยอะ ได้ไอเดียเซ็ตที่ตรงโจทย์เร็วขึ้นมาก', r: 'ฝ่ายการตลาด · เอเจนซี', a: 'M' },
  { q: 'เห็น Mockup ก่อนผลิตทำให้ตัดสินใจได้สบายใจ ไม่ต้องลุ้นว่างานจะพลาด', r: 'ฝ่ายจัดซื้อ · บริษัทมหาชน', a: 'P' },
];
