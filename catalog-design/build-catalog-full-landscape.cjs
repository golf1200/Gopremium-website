...
.c1 .photo img{width:100%;height:100%;object-fit:cover;object-position:48% center;transform:scale(1.36);transform-origin:48% center}
.c1 .photo:after{content:"";position:absolute;left:0;top:0;bottom:0;width:120px;background:linear-gradient(90deg,#fff 26%,transparent);z-index:2}
.c1 .photo:before{content:"";position:absolute;right:0;top:0;bottom:0;width:100px;background:linear-gradient(270deg,#fff 14%,transparent);z-index:2}
...
.about .photo:after{content:"";position:absolute;left:0;top:0;bottom:0;width:100px;background:linear-gradient(90deg,#fff 24%,transparent);z-index:2}
.about .clients{padding:11px 16mm 11mm;border-top:1px solid var(--line);background:#fff}
...
/* ============ TOC ============ */
.toc{padding:12mm 18mm 0}
.toc .hd{display:flex;align-items:center;justify-content:space-between}
.toc-h{font-family:var(--thai);font-weight:700;color:var(--navy);font-size:34px;margin-top:10px}
.toc .rule{margin:14px 0 10px}
.toc-list{margin-top:14px}
.toc-row{display:flex;align-items:center;gap:16px;padding:9px 4px;border-bottom:1px solid var(--line)}
...
.toc-note{margin-top:14px;background:var(--cloud);border-left:3px solid var(--gold);border-radius:8px;padding:13px 16px;font-size:12.5px;color:var(--grey);display:flex;align-items:center;gap:10px;line-height:1.5}
...
.rhead{padding:9mm 16mm 0;display:flex;align-items:center;justify-content:space-between}
...
.rrule{margin:6mm 16mm 0;height:2px;background:linear-gradient(90deg,var(--navy) 0 56px,var(--line) 56px)}
.grid{flex:1;padding:6mm 16mm 15mm;display:grid;grid-template-columns:repeat(4,1fr);grid-auto-rows:max-content;gap:5mm;align-content:start}
.card{border:1px solid var(--line);border-radius:13px;overflow:hidden;display:flex;flex-direction:column;background:#fff}
.card .im{position:relative;aspect-ratio:4/3;background:#fff;display:flex;align-items:center;justify-content:center;padding:5px}
.card .im img{max-width:100%;max-height:100%;width:auto;height:auto;object-fit:contain}
...
.pricenote{position:absolute;left:16mm;right:16mm;bottom:8mm;font-family:var(--disp);font-size:9.5px;color:var(--grey);letter-spacing:.01em}
...
.closing .photo img{width:100%;height:100%;object-fit:cover;object-position:43% 15%;transform:scale(1.32);transform-origin:43% 15%}
